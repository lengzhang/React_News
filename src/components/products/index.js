                  ...
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">
                        <div className="productlinks-item item-mail">
                            <strong className="className">
                                <a className="productlinks-i-mail" href="http://email.163.com/">邮箱</a>
                            </strong>
                    ...
                    <li className="list-group-item">
                        <div className="productlinks-item item-game">
                            ...
                            <a href="http://qnm.163.com/" className="pr0">倩女幽魂手游</a>
                    ...
                    <li className="list-group-item">
                        <div className="productlinks-item item-sns">
                            <strong className="className">
                                <a href="http://sitemap.163.com/" className="productlinks-i-sns">社区</a>
                            </strong>
                            ...
                            <a href="http://www.lofter.com/?act=qb163rk_20141031_12" style={{
                                    fontFamily: 'Arial',
                                    paddingRight: 0
                                }}>LOFTER</a>
